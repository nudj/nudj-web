...
<div class = "ask-referral-nudj">
	<div class="ask-referral-content">
        ...
        <?php 
          if(isset($unique_link)) {
            ...
            echo '<p class="ask-referral-title">Ask for A Referral</p>';
          }
    ...
    <?php if(!isset($unique_link)) {
        ...
        <form id="send-entire-network">
        	<input type="submit" class="referral-submit" name="send-entire-network" value="Ask Referral" />
        	<label class="emphasize">Send to entire Nudj Network</label>
        </form>
