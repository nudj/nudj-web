  ...
  if(isset($_POST['name']) and isset($_POST['email']) and isset($_POST['linkedin'])){
    ...
    // } else {
      ...
      //The form has been submitted, prep a nice thank you message
        ...
        $subject = 'Application - Mr & Mrs Smith';
...
<!-- MENU  -->
  ...
  <div class="apply-header">
    ...
    <p class="client-job">Digital marketing manager</p>
  ...
  <div>
    <form class="contaform" id="heroForm" action="" method="post" enctype="multipart/form-data">
      <div class="nudj-form">
        ...
        <br/>
        <input class="client-section-button" name="submit" type="submit" value="FIND OUT MORE" /> 
