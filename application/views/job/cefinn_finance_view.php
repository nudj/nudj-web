<script src=<?php echo asset_url()."js/clipboard.min.js";?> ></script>
  ...
  <div class = "client-section1">
    ...
    <p class="client-section-title max-width460">Cefinn, by Samantha Cameron Launching Spring 2017</p>
    <p class="client-section-description max-width685">Cefinn is a contemporary, ready-to-wear fashion brand comprising of modern designer dresses, tailoring and separates for women. Launched by Samantha Cameron and designed in London, Cefinn’s collection will be available to purchase on cefinn.com alongside our exclusive stockists Net-A-Porter and Selfridges in the Spring of 2017.</p>
  ...
  <div id="fixed-footer" class="fixed-footer">
    ...
    <div class="container-footer">
      <div class="left-side">
        <div class="poweredby-text">PUTTING YOUR CONNECTIONS TO WORK</div>
      </div>
    ...
    $( document ).ready(function() {
      ...
      $('#nudj-button3').click(function(){
        $('#copy-button3').fadeIn();
      });

      $('#copy-button3').click(function(){
        $('#copy-button3').fadeOut();
      });
